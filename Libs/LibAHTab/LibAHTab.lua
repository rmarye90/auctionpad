-- Vendored from https://github.com/TheMouseNest/LibAHTab (LibStub version 4).
-- MIT License, Copyright (c) 2022 plusmouse — see Libs/LibAHTab/LICENSE.
-- Do not edit this file's logic: any behavior change belongs in UI/AHTab.lua.
